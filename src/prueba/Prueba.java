...
public class Prueba {
	...
	public static void main(String[] args) {
		...
		Habitacion h1 = new HPrivada();
		sistema.clinica.agregaPrivada(h1);
		
		Habitacion h2 = new HCompartida();
		sistema.clinica.agregaCompartida(h2);
		
		Habitacion h3 = new HTerapiaIntensiva();
		sistema.clinica.agregaIntensiva(h3);
